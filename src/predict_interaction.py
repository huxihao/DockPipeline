...
def main(para):
    ...
    if 'NewList' not in para:
        ...
        para['ListFormat'] = 'p1/p2/a1/a2/pdb1/ch1/pdb2/ch2'
        with open(para['NewList'], 'w') as tempfile:
            tempfile.write('P49674\tO94687\tHhp1\tTas3\t4HOK\tA\t3D1D\tA\n')
    ...
    if para['OutMethod'] == 'RandomForest':
        ...
        residue_value = map_pdb_residue(feature_file, para2['MapFile'], idx_map[para['OutMethod']])
